...
1. ESRI ArcGIS Pro for Desktop exercises
2. `JupyterLab`_ for programming
...
6. `Slack`_ for communicating among Aalto students
...
You can access the polling system of our course from `presemo.aalto.fi/introsda <https://presemo.aalto.fi/introsda/>`__
...
questions about the lessons and exercises. All enrolled students have received an invite link to the ``IntroSDA`` workspace at the start of the course.
